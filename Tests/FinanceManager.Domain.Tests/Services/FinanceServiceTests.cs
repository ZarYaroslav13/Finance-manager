...
//    public async Task GetAllFinanceOperationTypesOfWalletAsync_ReceivedExpectedNumberFinanceOperationTypes_FinanceOperationTypesList(List<FinanceOperationType> financeOperationTypes, Guid walletId)
//    {
...
//    {
//        FinanceOperationTypeModel type = new() { Id = Guid.Parse("1") };
...
//    {
//        FinanceOperationTypeModel type = new() { Id = Guid.Parse("0") };
...
//        var wallet = new Wallet() { Id = Guid.Parse("1"), AccountId = Guid.Parse("2") };
...
//    #region Tests for GetAllFinanceOperationOfWallet(Guid walletId, int count = 0)
...
//    public void GetAllFinanceOperationOfWalletAsync_ArgumentsAreLessThenZero_ThrowsArgumentException(Guid walletId, int count, int index)
//    {
...
//    public async Task GetAllFinanceOperationOfWalletAsync_WithCountAndIndex_GetAllWasInvokedAndReceivedExpectedList_ListFinanceOperationModels(List<FinanceOperation> operations, Guid walletId, int index, int count)
//    {
//        A.CallTo(() => _financeOperationsRepository.GetAllAsync(A<Func<IQueryable<FinanceOperation>, IOrderedQueryable<FinanceOperation>>>._,
...
//    #region Tests for GetAllFinanceOperationOfWallet(Guid walletId, DateTime startDate, DateTime endDate)
...
//    {
//        IncomeModel operation = new(new()) { Id = Guid.Parse("1") };
...
//    {
//        var invalidtypeId = Guid.Parse("1");
...
//    {
//        IncomeModel operation = new(new()) { Id = Guid.Parse("0") };
