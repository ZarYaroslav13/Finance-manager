...
//    {
//        WalletModel wallet = new() { Id = Guid.Parse("1") };
...
//    {
//        WalletModel wallet = new() { Id = Guid.Parse("0") };
...
//    public void IsAccountOwnerWalletAsync_InvalidAccountIdOrWalletId_ThrowsArgumentOutOfRangeException(int accountId, Guid walletId)
//    {
...
//    {
//        Wallet wallet = new() { Id = Guid.Parse("1"), AccountId = Guid.Parse("2") };
